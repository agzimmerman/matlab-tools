...
%% Configure options.
DefaultPairs = {'LineColorSliceNames', {}, 'LineTypeSliceNames', {},...
    'FigureSliceNames', {},...
    'SaveFiguresAs', {}, 'PlotFunction', @plot,...
    'ManualLimits', [], 'SetXTicks', false, 'YMinMeanMax', false,...
    'EqualAxis', false, 'LegendLocation', 'Best',...
    'LineStyle', '-'};
